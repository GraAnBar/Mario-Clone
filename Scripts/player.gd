...
const SMALL_CHARACTER_COLLISION_SHAPE = preload("res://Resources/CollisionShapes/small_character_collision_shape.tres")
const BIG_CHARACTER_COLLISION_SHAPE = preload("res://Resources/CollisionShapes/big_character_collision_shape.tres")
...
@onready var slide_down_finish_position = $"../SlideDownFinishPosition"
...
func set_collision_shapes(is_small: bool):
	var collision_shape = SMALL_CHARACTER_COLLISION_SHAPE if is_small else BIG_CHARACTER_COLLISION_SHAPE
...
func big_to_small():
	set_collision_layer_value(1, false)
	set_physics_process(false)
	var animation_name = "small_to_big"
...
func on_pole_hit():
	...
	var slide_down_position = slide_down_finish_position.position
